...
<body>
    ...
    <div class="navHolder">
     ...
     <div class="eventsHeader">
        <p style="font-size: 32pt;">Events</p>
     </div>
     ...
     <div class="eventsBody">
        ...
        <?php
            ...
            $getevent_query = "SELECT * FROM events";

            $getevent_results = mysqli_query($database, $getevent_query);

            $num_rows = mysqli_num_rows($getevent_results);
            $num_fields = mysqli_num_fields($getevent_results);

            for($row_num = 1; $row_num <= $num_rows; $row_num++) {
                $row_array = mysqli_fetch_array($getevent_results);
